...
<body class="login-page">
    ...
    <div class="login-container">
        <form method="POST" name="frm1" id="frm1" action="validacion.php" class="login-form needs-validation" novalidate>
            ...
            <button type="submit" class="btn btn-primary boton-login mb-3">Enviar</button>
            <a href="clienteRegistro.php" class="btn btn-info boton-login mt-2">Registrarse</a>
