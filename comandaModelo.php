...
class ComandaModelo {
    ...
    public function agregarComanda($cliente_id, $platillos_id, $totalComanda, $mesa_id, $comentarios, $estado, $cantidades, $precios) {
        try {
            $this->pdo->beginTransaction();

            $stmt = $this->pdo->prepare("INSERT INTO comandas (mesa_id, cliente_id, estado, total, comentarios) VALUES (?, ?, ?, ?, ?)");
            $stmt->execute([$mesa_id, $cliente_id, $estado, $totalComanda, $comentarios]);
