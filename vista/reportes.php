...
?>
    <div class="content">
        ...
        <form class="user-form needs-validation" action="controlador/reportesController.php" method="POST" novalidate>
            ...
            <div id="fechaEspecifica" style="display: none;">
                <div class="form-group">
    ...
    <script>
        ...
        function actualizarFormulario(valor) {
            ...
            var fechaEspecifica = document.getElementById('fechaEspecifica');
            ...
            } else if (valor === 'ingresos_totales' || valor === 'platillos_vendidos' || valor === 'ingresos_categoria') {
                periodosIngresos.style.display = 'block';
            }
            
            if (valor === 'ingresos_categoria') {
