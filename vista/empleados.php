...
?>
    ...
    <button class="btn btn-primary my-3 btn-Agregar" data-bs-toggle="modal" data-bs-target="#nuevoEmpleadoModal"><i class="fas fa-plus me-2"></i>Nuevo Empleado</button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#confirmarEliminarModal<?= $empleado['id'] ?>">
            ...
            <div class="modal-content">
                <form id="nuevoEmpleadoForm" action="index.php?c=empleado&m=guardarEmpleado" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Fecha de Contratación</label>
                            <input type="date" name="fecha_contratacion" class="form-control" min="2020-01-01" max="2025-01-01" required>
                            <div class="invalid-feedback">Por favor, ingrese la fecha de contratación (2020 a 2025).</div>
                        </div>
                        <div class="mb-3">
                            <label>Salario</label>
                        ...
                        <div class="mb-3">
                            <select name="zona_asignada" class="form-control" required>
