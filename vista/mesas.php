...
?>
    ...
    <?php if($usuarioRol == 'administrador') { ?>
        <button class="btn btn-primary my-3 btn-Agregar" data-bs-toggle="modal" data-bs-target="#agregarMesaModal"><i class="fas fa-plus me-2"></i>Agregar Mesa</button>
        <button class="btn btn-primary my-3 btn-Agregar" data-bs-toggle="modal" data-bs-target="#agregarZonaModal"><i class="fas fa-plus me-2"></i>Agregar Zona</button>
        <button class="btn btn-primary my-3 btn-Agregar" data-bs-toggle="modal" data-bs-target="#verZonasModal"><i class="fas fa-eye me-2"></i>Ver Zonas</button>
                        ...
                        <form id="editarZonaForm<?= $zona['id'] ?>" action="index.php?c=mesa&m=actualizarZona" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="descripcion" class="form-control" value="<?= strtoupper($zona['descripcion']) ?>" required>
                                    <div class="invalid-feedback">Por favor, ingrese una descripcion para la zona</div>
                                </div>
                            </div>
                            <div class="modal-footer">
