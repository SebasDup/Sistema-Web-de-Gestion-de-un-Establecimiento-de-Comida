        ...
        <div class="modal-content">
            <form id="editarPromoForm<?= $promo['id'] ?>" action="index.php?c=promocion&m=actualizarPromocion" method="POST" class="needs-validation" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="fecha_inicio" class="form-label">Fecha de inicio</label>
                        <input type="date" class="form-control" name="fecha_inicio" value="<?= $promo['fecha_inicio'] ?>" required min="<?php echo date('Y-m-d'); ?>">
                        <div class="invalid-feedback">Por favor seleccione una fecha de inicio.</div>
                    </div>
                    <div class="mb-3">
                        <label for="fecha_fin" class="form-label">Fecha de fin</label>
                        <input type="date" class="form-control" name="fecha_fin" value="<?= $promo['fecha_fin'] ?>" required min="<?php echo date('Y-m-d'); ?>">
