    ...
    setTimeout(() => {
        toast.remove();
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="editarBuscarPlatillo" class="form-control" placeholder="Ingrese el nombre del platillo">
                        ...
                        <div class="invalid-feedback">Por favor, seleccione al menos un platillo.</div>
                    </div>
                            ...
                            platillos.forEach(platillo => {
                                ...
                                if (nombrePlatillo.includes(query)) {
                                    ...
                                    li.addEventListener('click', function() {
                                        ...
                                        listaPlatillos.innerHTML = '';
                                        document.getElementById('editarBuscarPlatillo').value = '';
                                    });
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="validarFormulario('editarComandaForm')">Guardar cambios</button>
        ...
        <div class="modal-content">
            <form id="nuevaComandaForm" action="index.php?c=comanda&m=guardarComanda" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label>Platillos</label>
                        <input type="text" id="buscarPlatillo" class="form-control" placeholder="Ingrese el nombre del platillo">
                    ...
                    function agregarPlatillo(platillo) {
                        // Existing code remains the same until creating the div
                        const div = document.createElement('div');
                        div.className = 'alert alert-secondary d-flex justify-content-between align-items-center';
                        
                        // Create container for platillo info and quantity
                        const infoContainer = document.createElement('div');
                        infoContainer.className = 'd-flex align-items-center';
                        ...
                        div.appendChild(btnEliminar);
                        platillosSeleccionados.appendChild(div);
                        actualizarPlatillos();
                    }
                            ...
                            platillos.forEach(platillo => {
                                ...
                                if (nombrePlatillo.includes(query)) {
                                    ...
                                    li.addEventListener('click', function() {
                                        ...
                                        listaPlatillos.innerHTML = '';
                                        document.getElementById('buscarPlatillo').value = '';
                                    });
                                    listaPlatillos.appendChild(li);
                                }
                            });
            ...
            <tbody>
                <?php foreach ($comandas as $comanda): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($comanda['comentarios']); ?></td>
