    ...
    <table class="table table-striped user-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $usuario['email'] ?></td>
                <td>
                    <button class="btn-Editar btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editarUsuarioModal<?= $usuario['id'] ?>">Modificar</button>
                    <button class="btn-Eliminar btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmarEliminarModal<?= $usuario['id'] ?>">Eliminar</button>
                </td>
            </tr>
