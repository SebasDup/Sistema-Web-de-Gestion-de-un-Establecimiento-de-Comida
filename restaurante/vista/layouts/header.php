...
<body>
    <div class="container-fluid p-0">
        ...
        <nav class="sidebar">
            ...
            <ul>
                <?php if ($usuarioRol == 'administrador'): ?>
                    <li><a href="http://localhost/restaurante/index.php?c=admin&m=index" <?php echo ($_SESSION['paginaActual'] == 'inicio') ? 'class="active"' : ''; ?>>Inicio</a></li>
                    <li><a href="http://localhost/restaurante/index.php?c=usuario&m=index" <?php echo ($_SESSION['paginaActual'] == 'usuarios') ? 'class="active"' : ''; ?>>Usuarios</a></li>
                    <li><a href="http://localhost/restaurante/index.php?c=empleado&m=index" <?php echo ($_SESSION['paginaActual'] == 'empleados') ? 'class="active"' : ''; ?>>Empleados</a></li>
                    <li><a href="http://localhost/restaurante/index.php?c=menu&m=index" <?php echo ($_SESSION['paginaActual'] == 'menu') ? 'class="active"' : ''; ?>>Menú</a></li>
