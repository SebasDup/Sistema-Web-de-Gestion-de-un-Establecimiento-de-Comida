...
class ComandaControlador {
    ...
    public function guardarComanda(){
        if (isset($_POST['cliente_id']) && !empty($_POST['platillos']) && isset($_POST['total']) && isset($_POST['id_mesa']) && isset($_POST['cantidades']) && isset($_POST['precios']) && isset($_SESSION['usuario_id'])) {
            ...
            $this->modelo->agregarComanda($cliente_id, $platillos_id, $totalComanda, $mesa_id, $comentarios, $estado, $cantidades, $precios, $id_Empleado);
        }else{
