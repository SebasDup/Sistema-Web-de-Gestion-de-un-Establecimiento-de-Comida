...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch($reporte) {
        ...
        case 'platillos_vendidos':
            $tipo_periodo = isset($_POST['tipo_periodo']) ? $_POST['tipo_periodo'] : '';
            header("Location: ../vista/reportes/PlatillosVendidos.php?periodo=$tipo_periodo");
            break;
        ...
        case 'ingresos_categoria':
            ...
            $tipo_periodo = isset($_POST['tipo_periodo']) ? $_POST['tipo_periodo'] : '';
            header("Location: ../vista/reportes/IngresosPorCategoria.php?categoria=" . urlencode($categoria) . "&periodo=$tipo_periodo");
            break;
        default:
