...
?>
    <h2 class="mt-4">Gestión de Reportes</h2>
    <?php if($usuarioRol == 'administrador'): ?>
        <button class="btn btn-primary my-3 btn-Agregar" data-bs-toggle="modal" data-bs-target="#agregarMenuModal">Generar Reporte</button>
    <?php endif; ?>
<?php
