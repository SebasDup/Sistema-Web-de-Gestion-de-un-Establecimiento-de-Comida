    ...
    function showReservationsModal(day, hour, reservaciones) {
        ...
        reservaciones.forEach(reservacion => {
            ...
            div.innerHTML = `
                ...
                Mesa ${mesasReservacion}<br>
                Personas: ${reservacion.personas}<br>
                Comentarios: ${comentarios}<br>
                <i class="fas fa-edit" style="cursor: pointer;" onclick="$('#reservacionesModal').modal('hide'); editarReservacion(${reservacion.id},'${nombreCompleto}',${reservacion.personas},'${reservacion.fecha}','${mesasReservacion}')"></i>
                <i class="fas fa-trash-alt" style="cursor: pointer;" onclick="eliminarReservacion(${reservacion.id})"></i>
            `;
